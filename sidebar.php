...
.menu-container {
    flex-grow: 1; /* Allows menu to expand while keeping logout button at the bottom */
    overflow-y: auto; /* Enable scrolling if content overflows */
    padding-bottom: 10px; /* Prevents content from overlapping logout button */
}
...
<div class="text-center" style="display: flex; align-items: center; justify-content: center; position: relative;">
    ...
    <a href="admindashboard.php" style="position: absolute; left: 0;">
        <img src="back.png" alt="Admin Icon" width="30" height="30">
    </a>
</div>
